...
class SolveTSPUsingACO:
    ...
    def __init__(self, nodes, iterations, colony_size, alpha, beta,
                 rho, pheromone_deposit_weight, labels=None):
        self.edges = nodes
...
#         mode='ACS', colony_size=_colony_size, steps=_steps, nodes=_nodes)
#     acs.run()
#     acs.plot()
#     elitist = SolveTSPUsingACO(
#         mode='Elitist', colony_size=_colony_size, steps=_steps, nodes=_nodes)
#     elitist.run()
#     elitist.plot()
